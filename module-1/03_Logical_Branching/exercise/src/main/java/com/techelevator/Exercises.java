...
public class Exercises {
	...
	public int sumDouble(int a, int b) {
		...
		// check if the two values are the same. If false add them together. If true add them together and double it.
		if (a != b) {
			return a + b;
		} else {
			return (a + b) * 2;
	...
	public int diff21(int n) {
		...
		// if n is less than or equal to 21, return the absolute value of the difference
		if (n <= 21) {
			return 21 - n;
		} else {
			return (n - 21) * 2;
		}
		// if n is greater than or equal to 21, return double the absolute value of the difference
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		...
		// check to see if the parrot is talking before 7 or after 20. If either are true return true. else return false
	...
	public boolean makes10(int a, int b) {
		// check to see if their sum is 10. if so, return true.
		if (a + b == 10) {
			return true;
		} else if (a == 10 || b ==10) {
			return true;
		...
		// if their sum is not 10, check to see if either one of them is 10. If so return true
	}
	...
	public int max1020(int a, int b) {
		...
		//check to see if both are in the range, if they are return the larger value
	...
	public int dateFashion(int you, int date) {
		...
		if ((you <= 10 && you >= 8) && (date >= 3 && date <= 10)) {
			return 2;
		} else if ((you <= 10 && you >= 3) && (date >= 8 && date <= 10)) {
			return 2;
		} else if ((you <=2 && you >= 0) || (date >= 0 && date <= 2)) {
			return 0;
		} else return 1;
	}
