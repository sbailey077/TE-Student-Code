<template>
  <div class="product" v-bind:class="{ bestseller:product.is_top_seller}">
    ...
    <div class="rating">
        <img src="../assets/star.png" class="ratingStar" v-for="star in numberOfStars" v-bind:key="star.id">
        <img src="../assets/star_empty.png" class="ratingStar" v-for="n in numberOfEmptyStars" v-bind:key="n.id">
