...
# should have logged onto GitLab, found their repo and cloned it. During that process,
# any issues with credentials (such as logging on with a Google-Id) would have been resolved.

# The script will then prompt the user for name, email before configuring
...
git remote add upstream "https://git.techelevator.com/campuses/cbus/jan-2022/java-blue/instructor-code.git"
