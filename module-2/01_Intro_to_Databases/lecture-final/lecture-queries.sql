...
-- The same but for cities NOT IN New England
SELECT city_name, area, population
FROM city
...
-- ILIKE is postgres only and is a case insensitive LIKE
SELECT city_name 
FROM city
...
-- Select parks established between 1900 and 1978
SELECT *
FROM park
WHERE date_established BETWEEN '1900-1-1' AND '1978-1-1';
