...
SELECT * FROM movie_actor WHERE actor_id = (SELECT person_id FROM person WHERE person_name = 'Penn Jillette');

DELETE FROM movie_actor WHERE actor_id = 37221;

SELECT person_id FROM person WHERE person_name = 'Penn Jillette';
