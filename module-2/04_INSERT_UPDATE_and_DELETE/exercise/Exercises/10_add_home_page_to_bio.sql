...
SELECT * FROM person WHERE birthday < '01/01/1950' AND home_page IS NOT null;

UPDATE person SET biography = biography || ' ' || home_page WHERE birthday < '01/01/1950' AND home_page IS NOT null;
